...
st.write("Embark on a journey of personal growth and unlock your full potential with daily challenges and progress tracking.")
...
if page == "🏠 Home":
    ...
    if st.button("✅ Submit Quiz"):
        ...
        if score == 3:
            ...
            st.write("👍 Good job! Keep nurturing your growth mindset!")
        else:
            st.write("💪 There's room for improvement. Keep trying!")
...
# Add a custom footer with the copyright
st.markdown(
    """
    <div style="text-align: center; font-size: 14px; color: #888;">
        &copy; 2025 Zeenat Somroo. All Rights Reserved.
    </div>
    """, unsafe_allow_html=True)
